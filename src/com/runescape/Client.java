...
public class Client extends GameStub {
	...
	public int[] anIntArray996 = new int[2000];
	...
	private static int[] anIntArray1044 = new int[99];
	...
	public final void method16(int i) {
		try {
			...
			while (crcValues[8] == 0) {
				...
				try {
					DataInputStream jagGrabInputStream = openJagGrabInputStream("crc"
							+ (int) (Math.random() * 9.9999999E7) + "-" + 317);
	...
	public final void method18(int i) {
		try {
			...
			if (aBoolean1281) {
				...
				method105(8, 0, 0, Widget.interfaces[anInt1301], 0);
			} else if (anInt1067 != -1) {
				method105(8, 0, 0, Widget.interfaces[anInt1067], 0);
			} else {
					...
					if (aStringArray969[i_12_] != null) {
						...
						if (i_13_ == 6 && anInt1220 == 0 && privateChatSetting < 2) {
							if (i_14_ > 0 && i_14_ < 110) {
								...
								typeface.drawRegularString(aStringArray969[i_12_],
				...
				String string;
				if (Client.clientsPlayer != null && Client.clientsPlayer.aString1723 != null) {
					string = Client.clientsPlayer.aString1723;
				} else {
				...
				if (anInt1111 == 0) {
					...
					if (aBoolean910) {
						if (i_19_ != 1) {
							...
							if (i_20_ < anInt974 - 10 || i_20_ > anInt974 + anInt976 + 10 || i_21_ < anInt975 - 10
									|| i_21_ > anInt975 + anInt977 + 10) {
								aBoolean910 = false;
								if (anInt973 == 1) {
									aBoolean1178 = true;
								}
						...
						if (i_19_ == 1 && menuActionRow > 0) {
							...
							if (i_30_ == 632 || i_30_ == 78 || i_30_ == 867 || i_30_ == 431 || i_30_ == 53
									|| i_30_ == 74 || i_30_ == 454 || i_30_ == 539 || i_30_ == 493 || i_30_ == 847
									|| i_30_ == 447 || i_30_ == 1125) {
								int i_31_ = anIntArray1116[menuActionRow - 1];
								int i_32_ = anIntArray1117[menuActionRow - 1];
								Widget widget = Widget.interfaces[i_32_];
								if (widget.itemSwapable || widget.itemDeletesDraged) {
									...
									if (Widget.interfaces[i_32_].interfaceParentId == anInt1301) {
										anInt1111 = 3;
									}
									break;
								}
	...
	public final void method21(boolean bool, int i, byte[] bs) {
		do {
			try {
				...
				SignLink.method556(bs, bs.length);
				if (i == 0) {
					break;
				}
				opcode = inBuffer.getUnsignedByte();
	...
	public final void method22(boolean bool) {
		try {
			try {
				...
				if (!aBoolean1184) {
					for (int i_35_ = 0; i_35_ < i; i_35_++) {
						int i_36_ = (anIntArray1259[i_35_] >> 8) * 64 - anInt1059;
					...
					for (int i_38_ = 0; i_38_ < i; i_38_++) {
						int i_39_ = (anIntArray1259[i_38_] >> 8) * 64 - anInt1059;
					...
					for (int i_41_ = 0; i_41_ < i; i_41_++) {
						...
						if (bs != null) {
							int i_42_ = (anIntArray1259[i_41_] >> 8) * 64 - anInt1059;
			...
			if (Client.lowMemory && SignLink.aRandomAccessFile613 != null) {
						...
						if (icon >= 0) {
							...
							if (icon != 22 && icon != 29 && icon != 34 && icon != 36 && icon != 46 && icon != 47
								...
								for (int off = 0; off < 10; off++) {
									...
									if (randPlane == 1 && drawPointX < i_94_ - 1 && drawPointX < viewportX + 3
									...
									if (randPlane == 3 && drawPointY < i_95_ - 1 && drawPointY < viewportY + 3
	...
	public final void method25(int i, int i_99_) {
		...
		if (linkedlist == null) {
			...
			currentScene.method503((byte) 7, i, i_106_, item_103_,
					method42(currentSceneId, i_99_ * 128 + 64, true, i * 128 + 64), item_104_, item, currentSceneId,
					i_99_);
		}
	}
		...
		try {
			if (widget.interfaceType == 0
				...
				for (int i_117_ = 0; i_117_ < i_116_; i_117_++) {
					...
					Widget widget_120_ = Widget.interfaces[widget.interfaceChildren[i_117_]];
			...
			SignLink.reportError("38948, " + i + ", " + i_111_ + ", " + widget + ", " + i_112_ + ", " + i_113_ + ", "
					+ i_114_ + ", " + i_115_ + ", " + runtimeexception.toString());
			throw new RuntimeException();
		}
	}
			...
			try {
				...
				if (anInt27 >= 412 && anInt27 <= 512 && anInt28 >= 467 && anInt28 <= 499) {
					if (anInt882 == -1) {
						...
						aString906 = "";
						aBoolean1183 = false;
						for (int i = 0; i < Widget.interfaces.length; i++) {
							if (Widget.interfaces[i] != null && Widget.interfaces[i].interfaceContentType == 600) {
								anInt1203 = anInt882 = Widget.interfaces[i].interfaceParentId;
								break;
							}
						}
					} else {
		...
		do {
			...
			if (i_140_ != 0) {
				...
				if (i_140_ == 3) {
					...
					if (i_141_ == 0) {
						method123((byte) 0, aBoolean1176, 0);
						aBoolean1176 = true;
					}
					if (i_141_ == 1) {
						method123((byte) 0, aBoolean1176, -400);
						aBoolean1176 = true;
					}
					if (i_141_ == 2) {
						method123((byte) 0, aBoolean1176, -800);
						aBoolean1176 = true;
					}
					if (i_141_ == 3) {
						method123((byte) 0, aBoolean1176, -1200);
						aBoolean1176 = true;
					}
					if (i_141_ == 4) {
						aBoolean1176 = false;
			...
			for (int i_143_ = -1; i_143_ < anInt916 + anInt861; i_143_++) {
				...
				if (actor != null && actor.isVisibile()) {
					...
					if (i_143_ < anInt916) {
						...
						if (player.anInt1726 != 0) {
							method127(true, actor, actor.anInt1527 + 15);
							if (anInt988 > -1) {
								for (int i_145_ = 0; i_145_ < 8; i_145_++) {
									if ((player.anInt1726 & 1 << i_145_) != 0) {
										anImageRGBArray1120[i_145_].method345(anInt988 - 12, 16083, anInt989 - i_144_);
										i_144_ -= 25;
									}
								}
							}
						...
						if (i_143_ >= 0 && hintIconType == 10 && hintIconPlayerId == anIntArray917[i_143_]) {
							method127(true, actor, actor.anInt1527 + 15);
							if (anInt988 > -1) {
								anImageRGBArray1120[7].method345(anInt988 - 12, 16083, anInt989 - i_144_);
							}
						}
					} else {
						NpcDefinition npcdefinition = ((Npc) actor).npcDefinition;
						if (npcdefinition.anInt431 >= 0 && npcdefinition.anInt431 < anImageRGBArray1120.length) {
							method127(true, actor, actor.anInt1527 + 15);
							if (anInt988 > -1) {
								anImageRGBArray1120[npcdefinition.anInt431].method345(anInt988 - 12, 16083,
										anInt989 - 30);
							}
						}
						if (hintIconType == 1 && hintIconNpcId == anIntArray862[i_143_ - anInt916]
								&& Client.currentCycle % 20 < 10) {
							method127(true, actor, actor.anInt1527 + 15);
							if (anInt988 > -1) {
								anImageRGBArray1120[2].method345(anInt988 - 12, 16083, anInt989 - 28);
							}
						}
					}
					if (actor.aString1526 != null
							&& (i_143_ >= anInt916 || publicChatSetting == 0 || publicChatSetting == 3 || publicChatSetting == 1
									&& method109(false, ((Player) actor).aString1723))) {
						method127(true, actor, actor.anInt1527);
						if (anInt988 > -1 && anInt999 < anInt1000) {
							anIntArray1004[anInt999] = aTypeFace1297.getStringWidth(actor.aString1526) / 2;
							...
							anIntArray1005[anInt999] = actor.anInt1533;
							anIntArray1006[anInt999] = actor.anInt1551;
							anIntArray1007[anInt999] = actor.anInt1555;
							aStringArray1008[anInt999++] = actor.aString1526;
							if (anInt1274 == 0 && actor.anInt1551 >= 1 && actor.anInt1551 <= 3) {
								anIntArray1003[anInt999] += 10;
								anIntArray1002[anInt999] += 5;
							}
							if (anInt1274 == 0 && actor.anInt1551 == 4) {
								anIntArray1004[anInt999] = 60;
							}
							if (anInt1274 == 0 && actor.anInt1551 == 5) {
					...
					if (actor.anInt1552 > Client.currentCycle) {
						method127(true, actor, actor.anInt1527 + 15);
						if (anInt988 > -1) {
							int i_146_ = actor.anInt1553 * 30 / actor.anInt1554;
							if (i_146_ > 30) {
								i_146_ = 30;
							}
					...
					for (int i_147_ = 0; i_147_ < 4; i_147_++) {
						if (actor.hitCycles[i_147_] > Client.currentCycle) {
							method127(true, actor, actor.anInt1527 / 2);
							if (anInt988 > -1) {
								if (i_147_ == 1) {
									anInt989 -= 20;
								}
								...
								anImageRGBArray1012[actor.hitTypes[i_147_]].method345(anInt988 - 12, 16083,
										anInt989 - 12);
								aTypeFace1295.drawString(String.valueOf(actor.hitDamages[i_147_]), anInt988,
										anInt989 + 4, 0);
								aTypeFace1295.drawString(String.valueOf(actor.hitDamages[i_147_]), anInt988 - 1,
										anInt989 + 3, 16777215);
							}
						}
					}
			...
			for (int i_148_ = 0; i_148_ < anInt999; i_148_++) {
				...
				if (anInt1274 == 0) {
					...
					if (anIntArray1006[i_148_] == 3) {
						aTypeFace1297.drawCenteredStringWaveXYMove(string, anInt988, anInt989 + 1, anInt1290,
								150 - anIntArray1007[i_148_], 0);
						aTypeFace1297.drawCenteredStringWaveXYMove(string, anInt988, anInt989, anInt1290,
					...
					if (anIntArray1006[i_148_] == 5) {
						...
						Rasterizer.setCoordinates(0, anInt989 - aTypeFace1297.characterDefaultHeight - 1, 512,
								anInt989 + 5);
	...
	public final void method36(byte b) {
		try {
			...
			if (b == -81) {
				...
				if (anInt1214 != -1) {
					method105(8, 0, 0, Widget.interfaces[anInt1214], 0);
				} else if (anIntArray1155[anInt1246] != -1) {
					method105(8, 0, 0, Widget.interfaces[anIntArray1155[anInt1246]], 0);
				}
		...
		try {
			if (l != 0L) {
				if (anInt924 >= 100 && anInt1071 != 1) {
					...
					if (!string.equals(Client.clientsPlayer.aString1723)) {
	...
	private final void method46(int i, Buffer buffer, byte b) {
		try {
			...
			while (buffer.bitOffset + 21 < i * 8) {
				...
				npc.anInt1574 = npc.npcDefinition.anInt423;
				npc.anInt1575 = npc.npcDefinition.anInt414;
				npc.anInt1576 = npc.npcDefinition.anInt439;
				npc.anInt1577 = npc.npcDefinition.anInt411;
				npc.anInt1531 = npc.npcDefinition.anInt433;
	...
	public final void method47(int i, boolean bool) {
		try {
			if (Client.clientsPlayer.xWithBoundary >> 7 == destinationX
					&& Client.clientsPlayer.yWithBoundary >> 7 == destinationY) {
				destinationX = 0;
			}
			int i_216_ = anInt916;
			if (i != 0) {
			...
			for (/**/; i_218_ < i_216_; i_218_++) {
				...
				if (player != null && player.isVisibile()) {
					...
					if ((Client.lowMemory && anInt916 > 50 || anInt916 > 200) && !bool
							&& player.anInt1537 == player.anInt1531) {
				...
				if (i == -48877) {
					...
					if (anInt1048 == 1) {
						...
						if (i_276_ != 0 && System.currentTimeMillis() - aLong849 > 360000L) {
							SignLink.reportError(aString1198 + " glcfb " + aLong1240 + "," + i_276_ + ","
									+ Client.lowMemory + "," + stores[0] + ","
									+ onDemandRequester.immediateRequestCount() + "," + currentSceneId + ","
									+ anInt1094 + "," + anInt1095);
							aLong849 = System.currentTimeMillis();
						}
					}
	...
	public final int method54(byte b) {
		try {
			...
			for (int i = 0; i < aByteArrayArray1208.length; i++) {
				...
				if (bs != null) {
					int i_277_ = (anIntArray1259[i] >> 8) * 64 - anInt1059;
	...
	public final void method56(int i) {
		try {
			...
			if (i == 0) {
				...
				aProducingGraphicsBuffer1132.createRasterizer();
				imagergb.method345(382 - imagergb.width / 2 - 128, 16083, 18);
				System.gc();
			}
		} catch (RuntimeException runtimeexception) {
	...
	public final boolean method59(byte[] bs, byte b, int i) {
		try {
			...
			return SignLink.method554(bs, i);
		} catch (RuntimeException runtimeexception) {
	...
	public final void method60(int i, byte b) {
		try {
			Widget widget = Widget.interfaces[i];
			for (int i_302_ = 0; i_302_ < widget.interfaceChildren.length; i_302_++) {
				if (widget.interfaceChildren[i_302_] == -1) {
					break;
				}
				Widget widget_303_ = Widget.interfaces[widget.interfaceChildren[i_302_]];
	...
	public final void method61(int i) {
		do {
			try {
				if (hintIconType == 2) {
					method128((hintIconX - anInt1059 << 7) + anInt962, hintIconOffset * 2, anInt900, (hintIconY
							- regionAbsoluteBaseY << 7)
							+ anInt963);
					if (i >= 0) {
						Client.aBoolean1249 = !Client.aBoolean1249;
					}
			...
			try {
				...
				if (loggedIn) {
						...
						if (anInt19 == 0) {
							...
							if (aBoolean1267 && anInt1014 >= 5) {
								...
								if (anInt1092 == anInt1109 && anInt1091 != anInt1110) {
									Widget widget = Widget.interfaces[anInt1109];
									int i_319_ = 0;
					...
					if (Scene.anInt550 != -1) {
						...
						boolean bool = calculatePath(0, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, i_325_,
	...
	public final void drawLoadingText(int i, String string) {
		do {
			...
			if (anArchive1078 == null) {
				...
				int i_331_ = 200;
				int i_332_ = 20;
				aTypeFace1297.drawString("RuneScape is loading - please wait...", i_330_ / 2, i_331_ / 2 - 26 - i_332_,
						16777215);
	...
	public final boolean method66(int i, int i_344_, int i_345_, int i_346_) {
		try {
			...
			if (i_349_ == 10 || i_349_ == 11 || i_349_ == 22) {
				...
				calculatePath(2, 0, i_352_, 0, Client.clientsPlayer.pathY[0], i_351_, i_353_, i_344_,
	...
	public final Archive method67(int i, String string, String string_354_, int i_355_, byte b, int i_356_) {
		try {
			...
			SignLink.reportError("44021, " + i + ", " + string + ", " + string_354_ + ", " + i_355_ + ", " + b + ", "
					+ i_356_ + ", " + runtimeexception.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void method69(int i, boolean bool) {
		try {
			if (i >= 0) {
				...
				if (menuActionId == 234) {
					boolean bool_375_ = calculatePath(2, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, interfaceid,
					...
					outBuffer.putLEShort(itemSlot + anInt1059);
				}
				if (menuActionId == 62 && method66(itemId, interfaceid, itemSlot, -770)) {
					...
					outBuffer.putLEShort(anInt1308);
					outBuffer.putLEShortA(itemSlot + anInt1059);
					outBuffer.putShort(anInt1310);
				}
				if (menuActionId == 511) {
					boolean bool_376_ = calculatePath(2, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, interfaceid,
							Client.clientsPlayer.pathX[0], false, itemSlot);
					if (!bool_376_) {
					...
					outBuffer.putShort(itemSlot + anInt1059);
				}
				if (menuActionId == 74) {
					...
					anInt1270 = itemSlot;
					anInt1271 = 2;
					if (Widget.interfaces[interfaceid].interfaceParentId == anInt882) {
						anInt1271 = 1;
					}
					if (Widget.interfaces[interfaceid].interfaceParentId == anInt1301) {
						anInt1271 = 3;
					}
				}
				if (menuActionId == 315) {
					Widget widget = Widget.interfaces[interfaceid];
				...
				if (menuActionId == 484 || menuActionId == 6) {
					...
					if (i_379_ != -1) {
						...
						for (int i_382_ = 0; i_382_ < anInt916; i_382_++) {
							...
							if (player != null && player.aString1723 != null
									&& player.aString1723.equalsIgnoreCase(string_380_)) {
								calculatePath(2, 0, 1, 0, Client.clientsPlayer.pathY[0], 1, 0, player.pathY[0],
										Client.clientsPlayer.pathX[0], false, player.pathX[0]);
								if (menuActionId == 484) {
				...
				if (menuActionId == 626) {
					...
					if (menuActionId == 213) {
						boolean bool_384_ = calculatePath(2, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, interfaceid,
								Client.clientsPlayer.pathX[0], false, itemSlot);
						if (!bool_384_) {
						...
						outBuffer.putLEShort(interfaceid + regionAbsoluteBaseY);
						outBuffer.putShort(itemId);
						outBuffer.putShortA(itemSlot + anInt1059);
					}
					if (menuActionId == 632) {
					...
					if (menuActionId == 652) {
						boolean bool_385_ = calculatePath(2, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, interfaceid,
								Client.clientsPlayer.pathX[0], false, itemSlot);
						if (!bool_385_) {
					...
					if (menuActionId == 94) {
						boolean bool_386_ = calculatePath(2, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, interfaceid,
								Client.clientsPlayer.pathX[0], false, itemSlot);
						if (!bool_386_) {
					...
					if (menuActionId == 646) {
						...
						outBuffer.putShort(interfaceid);
						Widget widget = Widget.interfaces[interfaceid];
						if (widget.interfaceFormulaes != null && widget.interfaceFormulaes[0][0] == 5) {
							int i_387_ = widget.interfaceFormulaes[0][1];
							if (anIntArray996[i_387_] != widget.interfaceConditionValues[0]) {
								anIntArray996[i_387_] = widget.interfaceConditionValues[0];
								method33(i_387_);
								aBoolean1178 = true;
							}
						}
					...
					if (menuActionId == 567) {
						boolean bool_388_ = calculatePath(2, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, interfaceid,
								Client.clientsPlayer.pathX[0], false, itemSlot);
						if (!bool_388_) {
					...
					if (menuActionId == 606) {
						...
						if (i_389_ != -1) {
							if (anInt882 == -1) {
								...
								aBoolean1183 = false;
								for (int i_390_ = 0; i_390_ < Widget.interfaces.length; i_390_++) {
									if (Widget.interfaces[i_390_] != null
											&& Widget.interfaces[i_390_].interfaceContentType == 600) {
										anInt1203 = anInt882 = Widget.interfaces[i_390_].interfaceParentId;
										break;
									}
								}
							} else {
					...
					if (menuActionId == 169) {
						...
						Widget widget = Widget.interfaces[interfaceid];
						if (widget.interfaceFormulaes != null && widget.interfaceFormulaes[0][0] == 5) {
							int i_394_ = widget.interfaceFormulaes[0][1];
							anIntArray996[i_394_] = 1 - anIntArray996[i_394_];
							method33(i_394_);
							aBoolean1178 = true;
						}
					}
					if (menuActionId == 447) {
						...
						if (menuActionId == 244) {
							boolean bool_396_ = calculatePath(2, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0,
									interfaceid, Client.clientsPlayer.pathX[0], false, itemSlot);
							if (!bool_396_) {
	...
	public final void method70(int i) {
		do {
			try {
				anInt1276 = 0;
				int i_397_ = (Client.clientsPlayer.xWithBoundary >> 7) + anInt1059;
		...
		try {
			...
			for (;;) {
				...
				if (anInt882 != -1 && anInt882 == anInt1203) {
					...
					if ((i_414_ >= 97 && i_414_ <= 122 || i_414_ >= 65 && i_414_ <= 90 || i_414_ >= 48 && i_414_ <= 57 || i_414_ == 32)
							&& aString906.length() < 12) {
					...
					if ((i_414_ == 13 || i_414_ == 10) && aString912.length() > 0) {
						...
						if (aString912.startsWith("::")) {
							...
							Client.clientsPlayer.aString1526 = aString912;
							Client.clientsPlayer.anInt1533 = i_421_;
							Client.clientsPlayer.anInt1551 = i_422_;
							Client.clientsPlayer.anInt1555 = 150;
							if (playerRights == 2) {
								sendMessage(Client.clientsPlayer.aString1526, 2, "@cr2@"
										+ Client.clientsPlayer.aString1723, aBoolean1016);
							} else if (playerRights == 1) {
								sendMessage(Client.clientsPlayer.aString1526, 2, "@cr1@"
										+ Client.clientsPlayer.aString1723, aBoolean1016);
							} else {
								sendMessage(Client.clientsPlayer.aString1526, 2, Client.clientsPlayer.aString1723,
										aBoolean1016);
							}
				...
				if (aStringArray969[i_427_] != null) {
					...
					if ((i_428_ == 1 || i_428_ == 2)
						...
						if (i_424_ > i_429_ - 14 && i_424_ <= i_429_
								&& !string.equals(Client.clientsPlayer.aString1723)) {
							if (playerRights >= 1) {
			...
			try {
				...
				if (i_431_ >= 1 && i_431_ <= 100 || i_431_ >= 701 && i_431_ <= 800) {
					...
					if (aBoolean1056) {
						...
						model.createBones();
						model.applyTransform(AnimationSequence.animationSequences[Client.clientsPlayer.anInt1531].animationForFrame[0]);
					...
					if (i_431_ == 650 || i_431_ == 655) {
						if (anInt1218 != 0) {
							...
							widget.disabledText = "You last logged in " + string + " from: " + SignLink.aString624;
						} else {
							widget.disabledText = "";
						}
					}
				...
				for (int i_442_ = 0; i_442_ < 100; i_442_++) {
					if (aStringArray969[i_442_] != null) {
						...
						if ((i_443_ == 3 || i_443_ == 7)
							...
							typeface.drawRegularString(string + ": " + aStringArray969[i_442_], i_446_, i_445_ - 1,
									65535);
							if (++i >= 5) {
								break;
							}
						...
						if (i_443_ == 6 && privateChatSetting < 2) {
							...
							typeface.drawRegularString("To " + string + ": " + aStringArray969[i_442_], 4, i_448_ - 1,
									65535);
							if (++i >= 5) {
								break;
							}
	...
	public final void sendMessage(String string, int i, String string_449_, boolean bool) {
		try {
			...
			SignLink.reportError("56346, " + string + ", " + i + ", " + string_449_ + ", " + bool + ", "
					+ runtimeexception.toString());
			throw new RuntimeException();
		}
	}
	...
	public final int method83(boolean bool, int i, int i_463_, int i_464_) {
		try {
			...
			SignLink.reportError("76365, " + bool + ", " + i + ", " + i_463_ + ", " + i_464_ + ", "
					+ runtimeexception.toString());
			throw new RuntimeException();
		}
	}
	...
	public final boolean calculatePath(int clickType, int objectRotation, int objectSizeY, int objectType,
		...
		while (currentIndex != nextIndex) {
			...
			if (objectType != 0) {
				if ((objectType < 5 || objectType == 10)
						&& currentCollisionMap[currentSceneId].reachedWall(toLocalX, currentX, currentY, 0,
								objectRotation, objectType - 1, toLocalY)) {
					foundDesination = true;
					break;
				}
				if (objectType < 10
						&& currentCollisionMap[currentSceneId].reachedDecoration(toLocalX, toLocalY, currentY,
								objectType - 1, objectRotation, currentX, 0)) {
					foundDesination = true;
					break;
				}
			}
			if (objectSizeX != 0
					&& objectSizeY != 0
					&& currentCollisionMap[currentSceneId].reachedFacingObject((byte) 1, toLocalY, toLocalX, currentX,
							objectSizeY, objectFace, objectSizeX, currentY)) {
				foundDesination = true;
				break;
			}
		...
		if (currentIndex > 0) {
			...
			outBuffer.putLEShortA(localX + anInt1059);
		...
		try {
			for (int i_512_ = 0; i_512_ < anInt918; i_512_++) {
				...
				if ((i_514_ & 0x10) != 0) {
					...
					if (i_515_ == npc.animation && i_515_ != -1) {
						...
						if (i_517_ == 2) {
							...
							|| npc.animation == -1
							|| AnimationSequence.animationSequences[i_515_].anInt57 >= AnimationSequence.animationSequences[npc.animation].anInt57) {
				...
				if ((i_514_ & 0x8) != 0) {
					...
					npc.anInt1553 = buffer.getUnsignedByteA();
					npc.anInt1554 = buffer.getUnsignedByte();
				}
				if ((i_514_ & 0x80) != 0) {
					npc.spotAnimationId = buffer.getUnsignedLEShort();
					int i_520_ = buffer.getInt();
					npc.anInt1544 = i_520_ >> 16;
					npc.anInt1543 = Client.currentCycle + (i_520_ & 0xffff);
					npc.currentAnimationFrame = 0;
					npc.anInt1542 = 0;
					if (npc.anInt1543 > Client.currentCycle) {
				...
				if ((i_514_ & 0x20) != 0) {
					npc.anInt1522 = buffer.getUnsignedLEShort();
					if (npc.anInt1522 == 65535) {
						npc.anInt1522 = -1;
					}
				}
				if ((i_514_ & 0x1) != 0) {
					npc.aString1526 = buffer.getString();
					npc.anInt1555 = 100;
				}
				if ((i_514_ & 0x40) != 0) {
					...
					npc.anInt1552 = Client.currentCycle + 300;
					npc.anInt1553 = buffer.getUnsignedByteS();
					npc.anInt1554 = buffer.getUnsignedByteC();
				}
				if ((i_514_ & 0x2) != 0) {
				...
				if ((i_514_ & 0x4) != 0) {
					npc.anInt1558 = buffer.getUnsignedShort();
					npc.anInt1559 = buffer.getUnsignedShort();
				}
			}
			loggedIn &= bool;
		} catch (RuntimeException runtimeexception) {
		...
		try {
			if (player != Client.clientsPlayer && menuActionRow < 400 && !bool) {
				...
				if (player.anInt1743 == 0) {
					string = player.aString1723
							+ Client.method110(Client.clientsPlayer.combatLevel, player.combatLevel, true) + " (level-"
							+ player.combatLevel + ")";
				} else {
					string = player.aString1723 + " (skill-" + player.anInt1743 + ")";
				}
				if (anInt1307 == 1) {
	...
	public final void method6() {
		...
		if (Client.aBoolean1018) {
			...
			if (!bool) {
				...
				if (SignLink.aRandomAccessFile613 != null) {
					for (int i = 0; i < 5; i++) {
						stores[i] = new Index(SignLink.aRandomAccessFile613, SignLink.aRandomAccessFileArray614[i],
								i + 1);
					}
				}
				try {
					...
					for (int i_566_ = 0; i_566_ < 100; i_566_++) {
						...
						if (anIndexedImageArray1085[i_566_] != null) {
							anIndexedImageArray1085[i_566_].mixPalette(i_562_ + i_565_, i_563_ + i_565_, i_564_
									+ i_565_);
						}
					}
					...
					for (int i_571_ = 5; i_571_ < 156; i_571_++) {
						...
						for (int i_574_ = 25; i_574_ < 172; i_574_++) {
							if (anIndexedImage1222.pixels[i_574_ + i_571_ * anIndexedImage1222.width] == 0
									&& (i_574_ > 34 || i_571_ > 34)) {
								if (i_572_ == 999) {
									i_572_ = i_574_;
								}
					...
					for (int i_575_ = 0; i_575_ < 9; i_575_++) {
						...
						int i_578_ = Rasterizer3D.anIntArray1490[i_576_];
			...
			while (buffer.bitOffset + 10 < i * 8) {
				...
				if (localPlayers[i_579_] == null) {
					...
					if (aBufferArray920[i_579_] != null) {
						localPlayers[i_579_].method401(0, aBufferArray920[i_579_]);
					}
				}
			...
			try {
				...
				if (anInt1046 == 0) {
					...
					if (i >= 0 && i_584_ >= 0 && i < 146 && i_584_ < 151) {
						...
						int i_586_ = Rasterizer3D.anIntArray1490[i_585_];
						int i_587_ = Rasterizer3D.anIntArray1491[i_585_];
						...
						boolean bool_592_ = calculatePath(1, 0, 0, 0, Client.clientsPlayer.pathY[0], 0, 0, i_591_,
								Client.clientsPlayer.pathX[0], true, i_590_);
						if (bool_592_) {
							outBuffer.put(i);
		...
		do {
			try {
				if (actor.anInt1568 == Client.currentCycle
						|| actor.animation == -1
						|| actor.anInt1549 != 0
						|| actor.anInt1548 + 1 > AnimationSequence.animationSequences[actor.animation].getFrameLength(
								actor.anInt1547, (byte) -39)) {
	...
	public final void method99(byte b, Actor actor) {
		do {
			try {
				actor.anInt1537 = actor.anInt1531;
				if (actor.pathLength == 0) {
					actor.anInt1523 = 0;
				} else {
					if (actor.animation != -1 && actor.anInt1549 == 0) {
					...
					if (i_609_ - i > 256 || i_609_ - i < -256 || i_610_ - i_608_ > 256 || i_610_ - i_608_ < -256) {
						...
						int i_612_ = actor.anInt1575;
						if (i_611_ >= -256 && i_611_ <= 256) {
							i_612_ = actor.anInt1574;
						} else if (i_611_ >= 256 && i_611_ < 768) {
							i_612_ = actor.anInt1577;
						} else if (i_611_ >= -768 && i_611_ <= -256) {
							i_612_ = actor.anInt1576;
						}
						if (i_612_ == -1) {
							i_612_ = actor.anInt1574;
						}
						...
						int i_613_ = 4;
						if (actor.anInt1572 != actor.anInt1530 && actor.anInt1522 == -1 && actor.anInt1524 != 0) {
							i_613_ = 2;
						}
						...
						if (i_613_ >= 8 && actor.anInt1537 == actor.anInt1574 && actor.anInt1525 != -1) {
							actor.anInt1537 = actor.anInt1525;
						}
						if (i < i_609_) {
		...
		do {
			try {
				if (i < 0 && actor.anInt1524 != 0) {
					if (actor.anInt1522 != -1 && actor.anInt1522 < 32768) {
						Npc npc = localNpcs[actor.anInt1522];
						if (npc != null) {
					...
					if (actor.anInt1522 >= 32768) {
						int i_616_ = actor.anInt1522 - 32768;
						if (i_616_ == anInt909) {
							i_616_ = playerId;
						}
					...
					if ((actor.anInt1558 != 0 || actor.anInt1559 != 0)
							&& (actor.pathLength == 0 || actor.anInt1523 > 0)) {
						int i_619_ = actor.xWithBoundary - (actor.anInt1558 - anInt1059 - anInt1059) * 64;
						int i_620_ = actor.yWithBoundary
								- (actor.anInt1559 - regionAbsoluteBaseY - regionAbsoluteBaseY) * 64;
					...
					if (actor.anInt1537 != actor.anInt1531 || actor.anInt1572 == actor.anInt1530) {
						break;
					}
					if (actor.anInt1532 != -1) {
						actor.anInt1537 = actor.anInt1532;
					} else {
						actor.anInt1537 = actor.anInt1574;
					}
				}
			} catch (RuntimeException runtimeexception) {
			...
			try {
				...
				if (actor.anInt1537 != -1) {
					...
					if (actor.anInt1538 < animationsequence.anInt50
							&& actor.anInt1539 > animationsequence.getFrameLength(actor.anInt1538, (byte) -39)) {
						actor.anInt1539 = 0;
						actor.anInt1538++;
					}
					if (actor.anInt1538 >= animationsequence.anInt50) {
				...
				if (actor.spotAnimationId != -1 && Client.currentCycle >= actor.anInt1543) {
					...
					for (actor.anInt1542++; actor.currentAnimationFrame < animationsequence.anInt50
							&& actor.anInt1542 > animationsequence.getFrameLength(actor.currentAnimationFrame,
									(byte) -39); actor.currentAnimationFrame++) {
						actor.anInt1542 -= animationsequence.getFrameLength(actor.currentAnimationFrame, (byte) -39);
					}
					if (actor.currentAnimationFrame >= animationsequence.anInt50
							&& (actor.currentAnimationFrame < 0 || actor.currentAnimationFrame >= animationsequence.anInt50)) {
						actor.spotAnimationId = -1;
					}
				}
				if (actor.animation != -1 && actor.anInt1549 <= 1) {
					AnimationSequence animationsequence = AnimationSequence.animationSequences[actor.animation];
				...
				if (actor.animation != -1 && actor.anInt1549 == 0) {
					AnimationSequence animationsequence = AnimationSequence.animationSequences[actor.animation];
					for (actor.anInt1548++; actor.anInt1547 < animationsequence.anInt50
							&& actor.anInt1548 > animationsequence.getFrameLength(actor.anInt1547, (byte) -39); actor.anInt1547++) {
		...
		try {
			...
			for (/**/; animableobject != null; animableobject = (AnimableObject) aLinkedList1081.getPrevious()) {
				if (animableobject.plane != currentSceneId || animableobject.transformCompleted) {
					...
					animableobject.method404(anInt970);
					if (animableobject.transformCompleted) {
						animableobject.remove();
					} else {
						currentScene.method507(animableobject.plane, 0, (byte) 6, animableobject.worldZ, -1,
		...
		try {
			...
			if (widget.interfaceType == 0
				...
				for (int i_632_ = 0; i_632_ < i_631_; i_632_++) {
					...
					Widget widget_635_ = Widget.interfaces[widget.interfaceChildren[i_632_]];
					...
					if (widget_635_.interfaceType == 0) {
						...
						if (widget_635_.interfaceType == 2) {
										...
										if (i_639_ > Rasterizer.topX - 32 && i_639_ < Rasterizer.bottomX
											...
											if (imagergb != null) {
												...
												if (imagergb.maxWidth == 33
													...
													aTypeFace1295.drawRegularString(Client.method43(-33245, i_647_),
															i_639_ + i_641_, i_640_ + 9 + i_642_, 16776960);
												}
											}
										}
								...
								if (string.indexOf("%") != -1) {
									for (;;) {
										...
										string = string.substring(0, i_651_)
												+ method93(369, method124(341, widget_635_, 0))
									...
									for (;;) {
										...
										string = string.substring(0, i_652_)
												+ method93(369, method124(341, widget_635_, 1))
									...
									for (;;) {
										...
										string = string.substring(0, i_653_)
												+ method93(369, method124(341, widget_635_, 2))
									...
									for (;;) {
										...
										string = string.substring(0, i_654_)
												+ method93(369, method124(341, widget_635_, 3))
									...
									for (;;) {
										...
										string = string.substring(0, i_655_)
												+ method93(369, method124(341, widget_635_, 4))
							...
							if (imagergb != null) {
								imagergb.method345(i_633_, 16083, i_634_);
							}
						} else if (widget_635_.interfaceType == 6) {
							int i_658_ = Rasterizer3D.centerWidth;
							int i_659_ = Rasterizer3D.centerHeight;
							Rasterizer3D.centerWidth = i_633_ + widget_635_.interfaceWidth / 2;
							Rasterizer3D.centerHeight = i_634_ + widget_635_.interfaceHeight / 2;
							int i_660_ = Rasterizer3D.anIntArray1490[widget_635_.rotationX] * widget_635_.zoom >> 16;
							int i_661_ = Rasterizer3D.anIntArray1491[widget_635_.rotationX] * widget_635_.zoom >> 16;
							...
							if (i_662_ == -1) {
								...
								model = widget_635_.getAnimatedModel(
										animationsequence.anIntArray52[widget_635_.animationFrame],
										animationsequence.animationForFrame[widget_635_.animationFrame], bool);
							}
							if (model != null) {
								model.method430(0, widget_635_.rotationY, 0, widget_635_.rotationX, 0, i_660_, i_661_);
							}
							Rasterizer3D.centerWidth = i_658_;
							Rasterizer3D.centerHeight = i_659_;
			...
			SignLink.reportError("5217, " + i + ", " + i_624_ + ", " + i_625_ + ", " + widget + ", " + i_626_ + ", "
					+ runtimeexception.toString());
			throw new RuntimeException();
		}
	}
		...
		do {
			try {
				...
				if ((i & 0x100) != 0) {
					...
					int i_683_ = buffer.getInt();
					player.anInt1544 = i_683_ >> 16;
					player.anInt1543 = Client.currentCycle + (i_683_ & 0xffff);
					player.currentAnimationFrame = 0;
					player.anInt1542 = 0;
					if (player.anInt1543 > Client.currentCycle) {
				...
				if ((i & 0x8) != 0) {
					int i_684_ = buffer.getUnsignedShort();
					if (i_684_ == 65535) {
						i_684_ = -1;
					}
					int i_685_ = buffer.getUnsignedByteC();
					if (i_684_ == player.animation && i_684_ != -1) {
						int i_686_ = AnimationSequence.animationSequences[i_684_].anInt63;
						if (i_686_ == 1) {
							player.anInt1547 = 0;
							player.anInt1548 = 0;
							player.anInt1549 = i_685_;
							player.anInt1550 = 0;
						}
						if (i_686_ == 2) {
							player.anInt1550 = 0;
							...
							|| player.animation == -1
							|| AnimationSequence.animationSequences[i_684_].anInt57 >= AnimationSequence.animationSequences[player.animation].anInt57) {
						player.animation = i_684_;
						player.anInt1547 = 0;
						player.anInt1548 = 0;
						player.anInt1549 = i_685_;
						player.anInt1550 = 0;
				...
				if ((i & 0x4) != 0) {
					player.aString1526 = buffer.getString();
					if (player.aString1526.charAt(0) == '~') {
						player.aString1526 = player.aString1526.substring(1);
						sendMessage(player.aString1526, 2, player.aString1723, aBoolean1016);
				...
				if ((i & 0x80) != 0) {
					int i_687_ = buffer.getUnsignedShort();
					int i_688_ = buffer.getUnsignedByte();
					int i_689_ = buffer.getUnsignedByteC();
					int i_690_ = buffer.offset;
					if (player.aString1723 != null && player.visibile) {
						long l = TextUtils.nameToLong(player.aString1723);
						boolean bool = false;
						if (i_688_ <= 1) {
						...
						if (!bool && anInt1276 == 0) {
							try {
								aBuffer859.offset = 0;
								buffer.getBytes(i_689_, 0, aBuffer859.payload);
								aBuffer859.offset = 0;
								String string = ChatEncoder.get(i_689_, aBuffer859);
								string = ChatCensor.censorString(string);
								player.aString1526 = string;
								player.anInt1533 = i_687_ >> 8;
								player.anInt1551 = i_687_ & 0xff;
								player.anInt1555 = 150;
								if (i_688_ == 2 || i_688_ == 3) {
									sendMessage(string, 1, "@cr2@" + player.aString1723, aBoolean1016);
								} else if (i_688_ == 1) {
									sendMessage(string, 1, "@cr1@" + player.aString1723, aBoolean1016);
								} else {
									sendMessage(string, 2, player.aString1723, aBoolean1016);
								}
							} catch (Exception exception) {
					...
					buffer.offset = i_690_ + i_689_;
				}
				if ((i & 0x1) != 0) {
					player.anInt1522 = buffer.getUnsignedShort();
					if (player.anInt1522 == 65535) {
						player.anInt1522 = -1;
					}
				}
				if ((i & 0x10) != 0) {
					int i_692_ = buffer.getUnsignedByteC();
					byte[] bs = new byte[i_692_];
					Buffer buffer_693_ = new Buffer(bs);
					buffer.getBytes(bs, 0, i_692_);
					aBufferArray920[i_682_] = buffer_693_;
					player.method401(0, buffer_693_);
				}
				if ((i & 0x2) != 0) {
					player.anInt1558 = buffer.getUnsignedShortA();
					player.anInt1559 = buffer.getUnsignedShort();
				}
				if ((i & 0x20) != 0) {
					int i_694_ = buffer.getUnsignedByte();
					int i_695_ = buffer.getUnsignedByteA();
					player.updateHits(i_695_, i_694_, Client.currentCycle);
					player.anInt1552 = Client.currentCycle + 300;
					player.anInt1553 = buffer.getUnsignedByteC();
					player.anInt1554 = buffer.getUnsignedByte();
				}
				if ((i & 0x200) == 0) {
					break;
				}
				...
				player.anInt1552 = Client.currentCycle + 300;
				player.anInt1553 = buffer.getUnsignedByte();
				player.anInt1554 = buffer.getUnsignedByteC();
			} catch (RuntimeException runtimeexception) {
				SignLink.reportError("50326, " + i + ", " + i_682_ + ", " + buffer + ", " + b + ", " + player + ", "
						+ runtimeexception.toString());
				throw new RuntimeException();
			}
			break;
		...
		do {
			try {
				...
				try {
					...
					SignLink.reportError("glfc_ex " + Client.clientsPlayer.xWithBoundary + ","
							+ Client.clientsPlayer.yWithBoundary + "," + anInt1039 + "," + anInt1040 + "," + anInt1094
							+ "," + anInt1095 + "," + anInt1059 + "," + regionAbsoluteBaseY);
					throw new RuntimeException("eek");
				}
				break;
			} catch (RuntimeException runtimeexception) {
	...
	public final boolean method109(boolean bool, String string) {
		try {
			...
			if (string.equalsIgnoreCase(Client.clientsPlayer.aString1723)) {
				return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
	...
	public final void method111(byte b, int i) {
		try {
			if (b == 2) {
				b = (byte) 0;
			} else {
			...
			SignLink.reportError("83178, " + b + ", " + i + ", " + runtimeexception.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void method112() {
		do {
			method76((byte) -13);
			if (anInt942 == 1) {
				anImageRGBArray1175[anInt941 / 100].method345(anInt939 - 8 - 4, 16083, anInt940 - 8 - 4);
				Client.anInt1167++;
			...
			if (anInt942 == 2) {
				anImageRGBArray1175[4 + anInt941 / 100].method345(anInt939 - 8 - 4, 16083, anInt940 - 8 - 4);
			}
			if (anInt1043 != -1) {
				method119(anInt970, false, anInt1043);
				method105(8, 0, 0, Widget.interfaces[anInt1043], 0);
			}
			if (anInt882 != -1) {
				method119(anInt970, false, anInt882);
				method105(8, 0, 0, Widget.interfaces[anInt882], 0);
			}
			method70(184);
			if (!aBoolean910) {
				method82(0);
			...
			if (anInt1080 == 1) {
				anImageRGBArray1120[1].method345(472, 16083, 296);
			}
		...
		do {
			try {
				...
				for (SpawnObjectNode spawnobjectnode = (SpawnObjectNode) aLinkedList1204.getBack(); spawnobjectnode != null; spawnobjectnode = (SpawnObjectNode) aLinkedList1204
					...
					if (spawnobjectnode.anInt1344 == 0) {
						if (spawnobjectnode.id < 0
								|| Region.method460(spawnobjectnode.id, spawnobjectnode.anInt1351, 8)) {
							method142(spawnobjectnode.y, spawnobjectnode.plane, spawnobjectnode.face,
									spawnobjectnode.anInt1351, spawnobjectnode.x, spawnobjectnode.type,
									spawnobjectnode.id, 4);
							spawnobjectnode.remove();
						}
					} else {
						...
						if (spawnobjectnode.anInt1352 == 0
								...
								&& (spawnobjectnode.anInt1341 < 0 || Region.method460(spawnobjectnode.anInt1341,
										spawnobjectnode.anInt1343, 8))) {
							method142(spawnobjectnode.y, spawnobjectnode.plane, spawnobjectnode.anInt1342,
									spawnobjectnode.anInt1343, spawnobjectnode.x, spawnobjectnode.type,
									spawnobjectnode.anInt1341, 4);
							spawnobjectnode.anInt1352 = -1;
							if (spawnobjectnode.anInt1341 == spawnobjectnode.id && spawnobjectnode.id == -1) {
								spawnobjectnode.remove();
							} else if (spawnobjectnode.anInt1341 == spawnobjectnode.id
									&& spawnobjectnode.anInt1342 == spawnobjectnode.face
									&& spawnobjectnode.anInt1343 == spawnobjectnode.anInt1351) {
								spawnobjectnode.remove();
							}
						}
					}
	...
	public final boolean method119(int i, boolean bool, int i_741_) {
		try {
			...
			Widget widget = Widget.interfaces[i_741_];
			for (int i_743_ = 0; i_743_ < widget.interfaceChildren.length; i_743_++) {
				if (widget.interfaceChildren[i_743_] == -1) {
					break;
				}
				Widget widget_744_ = Widget.interfaces[widget.interfaceChildren[i_743_]];
				...
				if (widget_744_.interfaceType == 6
					...
					if (i_746_ != -1) {
						...
						while (widget_744_.animationDuration > animationsequence.getFrameLength(
								widget_744_.animationFrame, (byte) -39)) {
							widget_744_.animationDuration -= animationsequence.getFrameLength(
									widget_744_.animationFrame, (byte) -39) + 1;
							...
							if (widget_744_.animationFrame >= animationsequence.anInt50) {
								...
								if (widget_744_.animationFrame < 0
										|| widget_744_.animationFrame >= animationsequence.anInt50) {
	...
	public final void method123(byte b, boolean bool, int i) {
		do {
			try {
				if (b == 0) {
					b = (byte) 0;
				...
				SignLink.aString632 = "voladjust";
			} catch (RuntimeException runtimeexception) {
				SignLink.reportError("30156, " + b + ", " + bool + ", " + i + ", " + runtimeexception.toString());
				throw new RuntimeException();
			}
			break;
		} while (false);
	...
	public final int method124(int i, Widget widget, int i_761_) {
		try {
			i = 91 / i;
			if (widget.interfaceFormulaes == null || i_761_ >= widget.interfaceFormulaes.length) {
				return -2;
			}
			try {
				int[] is = widget.interfaceFormulaes[i_761_];
				int i_762_ = 0;
				int i_763_ = 0;
				int i_764_ = 0;
				for (;;) {
					int i_765_ = is[i_763_++];
					int i_766_ = 0;
					int i_767_ = 0;
					if (i_765_ == 0) {
						return i_762_;
					...
					if (i_765_ == 1) {
						i_766_ = skillLevels[is[i_763_++]];
					}
					if (i_765_ == 2) {
						i_766_ = anIntArray1069[is[i_763_++]];
					}
					if (i_765_ == 3) {
						i_766_ = skillExps[is[i_763_++]];
					}
					if (i_765_ == 4) {
						Widget widget_768_ = Widget.interfaces[is[i_763_++]];
						int i_769_ = is[i_763_++];
						if (i_769_ >= 0 && i_769_ < ItemDefinition.itemCount
								&& (!ItemDefinition.getDefinition(i_769_).membersOnly || Client.membersWorld)) {
							for (int i_770_ = 0; i_770_ < widget_768_.items.length; i_770_++) {
								if (widget_768_.items[i_770_] == i_769_ + 1) {
									i_766_ += widget_768_.itemAmounts[i_770_];
								}
							}
						}
					}
					if (i_765_ == 5) {
						i_766_ = anIntArray996[is[i_763_++]];
					}
					if (i_765_ == 6) {
						i_766_ = Client.anIntArray1044[anIntArray1069[is[i_763_++]] - 1];
					}
					if (i_765_ == 7) {
						i_766_ = anIntArray996[is[i_763_++]] * 100 / 46875;
					}
					if (i_765_ == 8) {
						i_766_ = Client.clientsPlayer.combatLevel;
					}
					if (i_765_ == 9) {
						for (int i_771_ = 0; i_771_ < SkillConstants.SKILL_COUNT; i_771_++) {
							if (SkillConstants.SKILL_TOGGLES[i_771_]) {
								i_766_ += anIntArray1069[i_771_];
							}
						}
					}
					if (i_765_ == 10) {
						Widget widget_772_ = Widget.interfaces[is[i_763_++]];
						int i_773_ = is[i_763_++] + 1;
						if (i_773_ >= 0 && i_773_ < ItemDefinition.itemCount
								&& (!ItemDefinition.getDefinition(i_773_).membersOnly || Client.membersWorld)) {
							for (int i_774_ = 0; i_774_ < widget_772_.items.length; i_774_++) {
								if (widget_772_.items[i_774_] == i_773_) {
									i_766_ = 999999999;
									break;
								}
							}
					...
					if (i_765_ == 13) {
						int i_775_ = anIntArray996[is[i_763_++]];
						int i_776_ = is[i_763_++];
						i_766_ = (i_775_ & 1 << i_776_) != 0 ? 1 : 0;
					}
					if (i_765_ == 14) {
						int i_777_ = is[i_763_++];
						VarBit varbit = VarBit.aVarBitArray735[i_777_];
						...
						i_766_ = anIntArray996[i_778_] >> i_779_ & i_781_;
					}
					if (i_765_ == 15) {
						i_767_ = 1;
					}
					...
					if (i_765_ == 18) {
						i_766_ = (Client.clientsPlayer.xWithBoundary >> 7) + anInt1059;
					}
					if (i_765_ == 19) {
						i_766_ = (Client.clientsPlayer.yWithBoundary >> 7) + regionAbsoluteBaseY;
					}
					if (i_765_ == 20) {
						i_766_ = is[i_763_++];
					}
			...
			SignLink.reportError("72370, " + i + ", " + widget + ", " + i_761_ + ", " + runtimeexception.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			if (!bool) {
				...
				if (anInt1046 == 2) {
					...
					minimap.method349(151, i, anIntArray1254, 256 + anInt1195, anIntArray1077, -236, i_785_, 5, 25,
							146, i_784_);
					anImageRGB1147.method349(33, anInt1210, anIntArray1082, 256, anIntArray993, -236, 25, 0, 0, 33, 25);
					...
					for (int i_790_ = 0; i_790_ < anInt916; i_790_++) {
						...
						if (player != null && player.isVisibile()) {
							...
							if (Client.clientsPlayer.teamId != 0 && player.teamId != 0
									&& Client.clientsPlayer.teamId == player.teamId) {
								bool_793_ = true;
							}
							if (bool_791_) {
					...
					if (hintIconType != 0 && Client.currentCycle % 20 < 10) {
						...
						if (hintIconType == 2) {
							i_784_ = (hintIconX - anInt1059) * 4 + 2 - Client.clientsPlayer.xWithBoundary / 32;
							i_785_ = (hintIconY - regionAbsoluteBaseY) * 4 + 2 - Client.clientsPlayer.yWithBoundary
									/ 32;
							method81(anImageRGB896, -760, i_785_, i_784_);
						}
	...
	public final void method128(int i, int i_794_, int i_795_, int i_796_) {
		try {
			if (i < 128 || i_796_ < 128 || i > 13056 || i_796_ > 13056) {
				...
				i_797_ = i_802_;
				if (i_796_ >= 50) {
					anInt988 = Rasterizer3D.centerWidth + (i << 9) / i_796_;
					anInt989 = Rasterizer3D.centerHeight + (i_797_ << 9) / i_796_;
				} else {
					anInt988 = -1;
					anInt989 = -1;
				}
	...
	public final boolean method131(Widget widget, boolean bool) {
		try {
			...
			for (int i = 0; i < widget.interfaceConditionTypes.length; i++) {
				int i_819_ = method124(341, widget, i);
			...
			try {
				...
				if (anInt1065 > 0) {
					for (int i_821_ = 0; i_821_ < 256; i_821_++) {
						if (anInt1065 > 768) {
							anIntArray875[i_821_] = method83(true, anIntArray876[i_821_], anIntArray877[i_821_],
									1024 - anInt1065);
						} else if (anInt1065 > 256) {
							anIntArray875[i_821_] = anIntArray877[i_821_];
						} else {
							anIntArray875[i_821_] = method83(true, anIntArray877[i_821_], anIntArray876[i_821_],
									256 - anInt1065);
						}
					}
				} else if (anInt1066 > 0) {
					for (int i_822_ = 0; i_822_ < 256; i_822_++) {
						if (anInt1066 > 768) {
							anIntArray875[i_822_] = method83(true, anIntArray876[i_822_], anIntArray878[i_822_],
									1024 - anInt1066);
						} else if (anInt1066 > 256) {
							anIntArray875[i_822_] = anIntArray878[i_822_];
						} else {
							anIntArray875[i_822_] = method83(true, anIntArray878[i_822_], anIntArray876[i_822_],
									256 - anInt1066);
						}
					}
				} else {
				...
				for (int i_827_ = 1; i_827_ < i - 1; i_827_++) {
					...
					for (int i_830_ = i_829_; i_830_ < 128; i_830_++) {
						...
						if (i_831_ != 0) {
							...
							aProducingGraphicsBuffer1135.pixels[i_826_++] = ((i_831_ & 0xff00ff) * i_832_
									+ (i_834_ & 0xff00ff) * i_833_ & ~0xff00ff)
				...
				for (int i_836_ = 1; i_836_ < i - 1; i_836_++) {
					...
					for (int i_839_ = 0; i_839_ < i_838_; i_839_++) {
						...
						if (i_840_ != 0) {
							...
							aProducingGraphicsBuffer1136.pixels[i_826_++] = ((i_840_ & 0xff00ff) * i_841_
									+ (i_843_ & 0xff00ff) * i_842_ & ~0xff00ff)
			...
			try {
				...
				if (!bool_855_) {
					if (anInt858 == 0) {
						...
						aTypeFace1295.drawCenteredShadowedString(onDemandRequester.message, i / 2, i_857_, 7711145,
								true);
						i_857_ = i_856_ / 2 - 20;
					...
					if (anInt858 == 2) {
						...
						aTypeFace1297.drawShadowedString("Username: " + aString1198
								+ (anInt1241 == 0 & Client.currentCycle % 40 < 20 ? "@yel@|" : ""), i / 2 - 90, i_860_,
								true, 16777215);
						i_860_ += 15;
						aTypeFace1297.drawShadowedString("Password: " + TextUtils.censorPassword(aString1199)
					...
					if (anInt858 == 3) {
						aTypeFace1297.drawCenteredShadowedString("Create a free account", i / 2, i_856_ / 2 - 60,
								16776960, true);
						int i_863_ = i_856_ / 2 - 35;
						aTypeFace1297.drawCenteredShadowedString("To create a new account you need to", i / 2, i_863_,
								16777215, true);
						i_863_ += 15;
						aTypeFace1297.drawCenteredShadowedString("go back to the main RuneScape webpage", i / 2,
								i_863_, 16777215, true);
						i_863_ += 15;
						aTypeFace1297.drawCenteredShadowedString("and choose the red 'create account'", i / 2, i_863_,
								16777215, true);
						i_863_ += 15;
						aTypeFace1297.drawCenteredShadowedString("button at the top right of that page.", i / 2,
								i_863_, 16777215, true);
						i_863_ += 15;
						int i_864_ = i / 2;
		...
		try {
			...
			if (i_869_ == 84) {
				...
				if (i_869_ == 105) {
					...
					if (Client.clientsPlayer.pathX[0] >= i_877_ - i_881_
							&& Client.clientsPlayer.pathX[0] <= i_877_ + i_881_
							&& Client.clientsPlayer.pathY[0] >= i_878_ - i_881_
							&& Client.clientsPlayer.pathY[0] <= i_878_ + i_881_ && aBoolean873 && !Client.lowMemory
							&& trackCount < 50) {
				...
				if (i_869_ == 215) {
					...
					if (i_894_ >= 0 && i_895_ >= 0 && i_894_ < 103 && i_895_ < 103) {
						...
						if (i_899_ == 1) {
							...
							if (walldecoration != null) {
								walldecoration.aRenderable778 = new GameObject(walldecoration.anInt779 >> 14 & 0x7fff,
										0, 4, i_902_, (byte) 7, i_903_, i_901_, i_904_, i_900_, false);
							}
						}
						if (i_899_ == 2) {
					...
					if (i_869_ == 151) {
						...
						if (i_938_ >= 0 && i_939_ >= 0 && i_938_ < 104 && i_939_ < 104) {
							...
							AnimableObject animableobject = new AnimableObject(currentSceneId, Client.currentCycle,
									i_942_, i_940_, method42(currentSceneId, i_939_, true, i_938_) - i_941_, i_939_,
									i_938_);
	...
	public final void method141(ImageRGB imagergb, int i, int i_987_, boolean bool) {
		try {
			...
			SignLink.reportError("45113, " + imagergb + ", " + i + ", " + i_987_ + ", " + bool + ", "
					+ runtimeexception.toString());
			throw new RuntimeException();
		}
	}

	private final void method142(int i, int i_994_, int i_995_, int i_996_, int i_997_, int i_998_, int i_999_,
			int i_1000_) {
		do {
			try {
				...
				if (!Client.lowMemory || i_994_ == currentSceneId) {
					...
					Region.method470(currentScene, i_995_, i, i_996_, i_1007_, currentCollisionMap[i_994_],
							anIntArrayArrayArray1239, i_997_, i_999_, i_994_, (byte) 93);
				}
			} catch (RuntimeException runtimeexception) {
				SignLink.reportError("56911, " + i + ", " + i_994_ + ", " + i_995_ + ", " + i_996_ + ", " + i_997_
			...
			try {
				...
				if (opcode == 176) {
					...
					if (anInt1218 != 0 && anInt882 == -1) {
						SignLink.method552(TextUtils.decodeAddress(anInt1218));
						method147(537);
						int i_1029_ = 650;
						...
						aString906 = "";
						aBoolean1183 = false;
						for (int i_1030_ = 0; i_1030_ < Widget.interfaces.length; i_1030_++) {
							if (Widget.interfaces[i_1030_] != null
									&& Widget.interfaces[i_1030_].interfaceContentType == i_1029_) {
								anInt882 = Widget.interfaces[i_1030_].interfaceParentId;
								break;
							}
						}
					}
				...
				if (opcode == 64) {
					...
					for (SpawnObjectNode spawnobjectnode = (SpawnObjectNode) aLinkedList1204.getBack(); spawnobjectnode != null; spawnobjectnode = (SpawnObjectNode) aLinkedList1204
							.getPrevious()) {
						if (spawnobjectnode.x >= playerPositionX && spawnobjectnode.x < playerPositionX + 8
								&& spawnobjectnode.y >= playerPositionY && spawnobjectnode.y < playerPositionY + 8
								&& spawnobjectnode.plane == currentSceneId) {
				...
				if (opcode == 185) {
					...
					Widget.interfaces[i_1033_].modelType = 3;
					if (Client.clientsPlayer.npcDefinition == null) {
						Widget.interfaces[i_1033_].modelId = (Client.clientsPlayer.anIntArray1720[0] << 25)
								+ (Client.clientsPlayer.anIntArray1720[4] << 20)
								+ (Client.clientsPlayer.appearanceModels[0] << 15)
								+ (Client.clientsPlayer.appearanceModels[8] << 10)
								+ (Client.clientsPlayer.appearanceModels[11] << 5)
								+ Client.clientsPlayer.appearanceModels[1];
					} else {
						Widget.interfaces[i_1033_].modelId = (int) (305419896L + Client.clientsPlayer.npcDefinition.aLong434);
					}
					opcode = -1;
					return true;
				}
				...
				if (opcode == 72) {
					...
					Widget widget = Widget.interfaces[i_1035_];
				...
				if (opcode == 134) {
					...
					anIntArray1069[skillId] = 1;
					for (int i_1041_ = 0; i_1041_ < 98; i_1041_++) {
						if (skillExp >= Client.anIntArray1044[i_1041_]) {
							anIntArray1069[skillId] = i_1041_ + 2;
						}
					}
					opcode = -1;
					return true;
				...
				if (opcode == 73 || opcode == 241) {
					...
					int i_1078_ = anInt1059 - anInt1061;
				...
				if (opcode == 75) {
					...
					Widget.interfaces[i_1097_].modelType = 2;
					Widget.interfaces[i_1097_].modelId = i_1096_;
					opcode = -1;
					return true;
				}
				if (opcode == 114) {
				...
				if (opcode == 50) {
					...
					while (!bool_1122_) {
						...
						for (int i_1123_ = 0; i_1123_ < anInt924 - 1; i_1123_++) {
							if (anIntArray851[i_1123_] != Client.nodeId && anIntArray851[i_1123_ + 1] == Client.nodeId
									|| anIntArray851[i_1123_] == 0 && anIntArray851[i_1123_ + 1] != 0) {
				...
				if (opcode == 110) {
					...
					anInt1173 = inBuffer.getUnsignedByte();
					opcode = -1;
					return true;
				}
				if (opcode == 254) {
				...
				if (opcode == 68) {
					for (int i_1131_ = 0; i_1131_ < anIntArray996.length; i_1131_++) {
						if (anIntArray996[i_1131_] != anIntArray1070[i_1131_]) {
							anIntArray996[i_1131_] = anIntArray1070[i_1131_];
							method33(i_1131_);
							aBoolean1178 = true;
						}
					}
						...
						try {
							...
							if (senderPlayerRights == 2 || senderPlayerRights == 3) {
								sendMessage(string, 7,
										"@cr2@" + TextUtils.formatName(TextUtils.longToName(senderName)), aBoolean1016);
							} else if (senderPlayerRights == 1) {
								sendMessage(string, 7,
										"@cr1@" + TextUtils.formatName(TextUtils.longToName(senderName)), aBoolean1016);
							} else {
								sendMessage(string, 3, TextUtils.formatName(TextUtils.longToName(senderName)),
										aBoolean1016);
							}
						} catch (Exception exception) {
				...
				if (opcode == 246) {
					...
					if (interfaceModelId == 65535) {
						Widget.interfaces[interfaceId].modelType = 0;
						opcode = -1;
						return true;
					}
					ItemDefinition itemdefinition = ItemDefinition.getDefinition(interfaceModelId);
					Widget.interfaces[interfaceId].modelType = 4;
					Widget.interfaces[interfaceId].modelId = interfaceModelId;
					Widget.interfaces[interfaceId].rotationX = itemdefinition.modelRotation1;
					Widget.interfaces[interfaceId].rotationY = itemdefinition.modelRotation2;
					Widget.interfaces[interfaceId].zoom = itemdefinition.modelZoom * 100 / interfaceModelZoom;
					opcode = -1;
					return true;
				}
				if (opcode == 171) {
					...
					Widget.interfaces[interfaceId].hiddenUntilHovered = bool_1140_;
					opcode = -1;
					return true;
				}
				if (opcode == 142) {
				...
				if (opcode == 126) {
					...
					Widget.interfaces[interfaceid].disabledText = interfaceText;
					if (Widget.interfaces[interfaceid].interfaceParentId == anIntArray1155[anInt1246]) {
						aBoolean1178 = true;
					}
					opcode = -1;
					return true;
				...
				if (opcode == 8) {
					...
					int interfaceModelId = inBuffer.getUnsignedLEShort();
					Widget.interfaces[interfaceId].modelType = 1;
					Widget.interfaces[interfaceId].modelId = interfaceModelId;
					opcode = -1;
					return true;
				}
				if (opcode == 122) {
					...
					Widget.interfaces[interfaceId].disabledColor = (i_1148_ << 19) + (i_1149_ << 11) + (i_1150_ << 3);
					opcode = -1;
					return true;
				}
				if (opcode == 53) {
					...
					Widget widget = Widget.interfaces[i_1151_];
				...
				if (opcode == 230) {
					...
					Widget.interfaces[interfaceId].rotationX = modelRotationX;
					Widget.interfaces[interfaceId].rotationY = modelRotationY;
					Widget.interfaces[interfaceId].zoom = modelZoom;
					opcode = -1;
					return true;
				}
				if (opcode == 221) {
				...
				if (opcode == 87) {
					...
					if (anIntArray996[i_1169_] != i_1170_) {
						anIntArray996[i_1169_] = i_1170_;
						method33(i_1169_);
						aBoolean1178 = true;
						if (anInt1067 != -1) {
							aBoolean1248 = true;
				...
				if (opcode == 36) {
					...
					if (anIntArray996[i_1171_] != i_1172_) {
						anIntArray996[i_1171_] = i_1172_;
						method33(i_1171_);
						aBoolean1178 = true;
						if (anInt1067 != -1) {
							aBoolean1248 = true;
				...
				if (opcode == 34) {
					...
					Widget widget = Widget.interfaces[i_1175_];
					while (inBuffer.offset < anInt1032) {
				...
				String string = "T2 - " + opcode + "," + anInt867 + "," + anInt868 + " - " + anInt1032 + ","
						+ (anInt1059 + Client.clientsPlayer.pathX[0]) + ","
						+ (regionAbsoluteBaseY + Client.clientsPlayer.pathY[0]) + " - ";
		...
		try {
			...
			if (!aBoolean1185) {
				...
				method144(
						...
						i,
						anInt1039,
						method42(currentSceneId, Client.clientsPlayer.yWithBoundary, true,
								Client.clientsPlayer.xWithBoundary) - 50, i_1180_, anInt1040);
			}
			int i;
			if (!aBoolean1185) {
				i = method120(111);
	...
	static {
		...
		for (int i_1189_ = 0; i_1189_ < 99; i_1189_++) {
			...
			i += i_1191_;
			Client.anIntArray1044[i_1189_] = i / 4;
		}
