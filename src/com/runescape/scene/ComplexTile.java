...
public class ComplexTile {
	...
	protected int[] anIntArray196;
	protected int[] anIntArray197;
	protected int[] anIntArray198;
	protected int[] anIntArray199;
	protected int[] anIntArray200;
	protected int[] anIntArray201;
	protected int[] anIntArray202;
	protected int[] anIntArray203;
	protected int[] anIntArray204;
	protected boolean aBoolean205 = true;
	protected int anInt206;
	protected int anInt207;
	protected int anInt208;
	protected int anInt209;
	static int[] anIntArray210 = new int[6];
	static int[] anIntArray211 = new int[6];
	static int[] anIntArray212 = new int[6];
	static int[] anIntArray213 = new int[6];
	static int[] anIntArray214 = new int[6];
