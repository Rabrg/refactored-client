...
public class OnDemandRequester extends Requester implements Runnable {
	...
	private LinkedList sentRequests = new LinkedList();
	...
	private byte[] inputBuffer = new byte[500];
	public int cycle;
	private byte[][] filePriorities = new byte[4][];
	private Client client;
	private LinkedList passiveRequests = new LinkedList();
	private int offset;
	private int toRead;
	...
	private byte[] deflateOut = new byte[65000];
	private int[] animIndex;
	private Queue immediateRequests = new Queue();
	private InputStream inputStream;
	private Socket socket;
	private int[][] fileVersions = new int[4][];
	private int[][] fileCrc = new int[4][];
	private int immediateRequestsSent;
	private int passiveRequestsSent;
	private LinkedList toRequest = new LinkedList();
	private OnDemandNode onDemandNode;
	private LinkedList wanted = new LinkedList();
	private int[] regHash;
